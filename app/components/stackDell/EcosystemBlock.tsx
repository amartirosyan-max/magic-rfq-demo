  ...
  return (
    <div
      ...
      style={{
        clipPath: isActive
          ? ""
          : "polygon(0% 0%, calc(100% - 14.16px) 0%, 100% 50%, calc(100% - 14.16px) 100%, 0% 100%, calc(0% + 14.16px) 50%)",
        cursor: hasData ? "pointer" : "default",
        blockSize: isActive ? "auto" : "124px",
        marginInlineStart: isActive ? "" : "29px",
        inlineSize: isActive ? "100%" : "calc(100% - 14.5px)",
      }}
    >
      {isSubsystemsAvailable && (
        <>
          <div className="flex justify-center items-center gap-[8px] leading-[1.2]">
            <h2 className="text-[12px] font-semibold">OPEN ECOSYSTEM</h2>
