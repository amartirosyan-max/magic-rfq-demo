...
const InfrastructureBlock: React.FC<InfrastructureBlockProps> = ({
  layerData,
  ...
  const handleClickBlock = () => {
    openRightOptions("infrastructure");
  };
  ...
  return (
    <div
      ...
      className="infrastructure-block
      relative overflow-hidden
      flex flex-col items-center justify-between gap-[20px] 
      w-full pt-[8px] pb-[23px] px-[35px]
      bg-[#1D56C1] 
      before:content-['']
      before:absolute
      before:inset-0
      ...
      style={{
        clipPath: isActive
          ? ""
          : "polygon(calc(0% + 27px) 0%, 100% 0%, calc(100% - 27px) 100%, 0% 100%)",
      ...
      {isSubsystemsAvailable && (
        <>
          <div className="flex justify-center items-center gap-[8px] leading-[1.2]">
            <h2 className="text-[12px] font-semibold">INFRASTRUCTURE</h2>
